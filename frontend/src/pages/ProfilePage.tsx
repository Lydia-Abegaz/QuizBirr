      ...
      <div className="max-w-3xl mx-auto">
        ...
        <nav className="flex items-center justify-between p-4">
          <div className="flex items-center gap-2">
            <button onClick={() => navigate('/')} className="px-3 py-2 rounded bg-army-700 text-white font-bold">Home</button>
            <button onClick={() => navigate('/wallet')} className="px-3 py-2 rounded bg-army-700 text-white font-bold">Wallet</button>
            <button onClick={() => navigate('/tasks')} className="px-3 py-2 rounded bg-army-700 text-white font-bold">Tasks</button>
            <button onClick={() => navigate('/referral')} className="px-3 py-2 rounded bg-army-700 text-white font-bold">Referral</button>
          </div>
          <div>
            <button onClick={() => navigate('/profile')} className="px-3 py-2 rounded bg-yellow-400 font-black">Profile</button>
          </div>
        </nav>
              ...
              <section className="military-card-light rounded-2xl p-6 border-2 border-black/10">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-black text-army-900">{user.balance?.toFixed(2) || '0.00'}</p>
                  </div>
                  <div>
